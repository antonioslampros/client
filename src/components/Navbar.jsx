...
const Navbar = () => {
  ...
  return (
    ...
    <div className='sm:flex hidden flex-row justify-end gap-4'>
        <CustomButton btnType='button' title={address ? 'Create a campaign' : 'Connect wallet'} 
        ...
        <ul className='mb-4'>
            {navlinks.map((link) => (
                ...
                >
                    <img src={link.imgUrl} 
                    alt={link.name}
                    className={`w-[24px] h-[24px] object-contain ${isActive === link.name ? 'graysclale-0': 'grayscale'}`}
                    />
